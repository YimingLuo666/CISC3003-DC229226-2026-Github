...
<head>
    <title><?php echo htmlspecialchars($studentId . ' ' . $studentName, ENT_QUOTES, 'UTF-8'); ?></title>
    <meta charset="utf-8">
...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer
    ...
    <main class="mdl-layout__content mdl-color--grey-50">
        ...
        <footer class="exam-footer">
            CISC3003 Web Programming: <?php echo htmlspecialchars($studentId, ENT_QUOTES, 'UTF-8'); ?> <?php echo htmlspecialchars($studentName, ENT_QUOTES, 'UTF-8'); ?> 2026
        </footer>
    </main>    
</div>    <!-- / mdl-layout --> 
