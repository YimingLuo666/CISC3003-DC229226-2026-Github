  <div class="mdl-layout__drawer demo-drawer mdl-color--blue-grey-800 mdl-color-text--blue-grey-50">
       <div class="profile">
           <img src="images/profile.jpg" class="avatar" alt="John Locke profile photo">
           <div class="profile-name">John Locke</div>           
           <span>johnlocke@example.com</span>
       </div>

       <nav class="mdl-navigation demo-navigation mdl-color-text--blue-grey-300">
